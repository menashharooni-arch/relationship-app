...
export const productDocs = defineDocs([
  ...
  },
  {
    ...
    answer:
      "There's a small \"Made with SwiftCard — Get yours free\" badge, and it shows on every plan: on a card page it appears once a visitor taps Save Contact, and every Swift Links page ends with a \"Made with swiftcard.me\" footer link. Every card page also has a gradient \"Create your free SwiftCard\" button (with the SwiftCard logo) under \"Share this card\", on all plans. What a paid plan removes is SwiftCard's branding on the automated emails and texts you send.",
    detail:
