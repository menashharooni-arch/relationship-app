...
export const officeDocs = defineDocs([
  ...
  },
  {
    ...
    answer:
      "Team tab → the purple \"+ Add team member\" button at the top right. Enter their email (a name is optional) and press \"Send invite\". They get a passwordless invitation — they sign in with Google or a one-tap email link and their card arrives already branded with your company look. When their card goes live they can turn on notifications, and their dashboard then opens with the same short guided tour every new account gets.",
    detail:
