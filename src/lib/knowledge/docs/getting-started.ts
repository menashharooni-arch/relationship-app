...
export const gettingStartedDocs = defineDocs([
  ...
  },
  {
    ...
    answer:
      "Open the invitation link you were emailed (it looks like swiftcard.me/join/…) and sign in as the invited address — with Google, or with \"Email me a sign-in link\", which is the one place SwiftCard does passwordless sign-in. Then press \"Accept invitation →\". Your card comes pre-branded with the company look, you fill in your own details, and your team covers the plan — you're never asked to choose a plan or pay. When the card is live, \"Continue to dashboard\" opens a short guided tour.",
    detail:
      "Invitations expire after 14 days; an admin can resend from the Team tab of the admin console. You must sign in as the address that was invited — a different account won't accept it. If the browser is already signed in to another account, the invite page says \"This invite is for a different email\" and its button, \"Continue as <invited address>\", signs you out and back to the invite. Open the emailed sign-in link in the same browser that asked for it; if it opens somewhere else, you land back on the invite with a note and can send a new link. There is no special short team form any more: team members go through the same four-step card builder as everyone else, with the company-managed fields shown as \"Managed by your organization\" — company name, logo, website, office phone, fax and address, plus the bio, Instagram and pinned links when the company sets them, and the design when the company locks it. If you'd already built a card before accepting, that card becomes your company card and opens to finish; saving it takes you to the tour.",
  },
  {
