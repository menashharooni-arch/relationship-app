...
export const accountDocs = defineDocs([
  ...
  },
  {
    ...
    answer:
      "Settings → Advanced account settings → \"Account ownership and deletion\" → \"Delete account\". It's a short sequence — two questions about why you're leaving, an offer or two worth hearing, a list of exactly what you'd lose, then \"Type DELETE\" and your password. It's a soft delete: for 30 days you can sign back in and press \"Reopen my account\" with everything intact. After that it's purged permanently and cannot be restored.",
    detail:
      "The steps are numbered (\"Step 3 of 6\") and nothing traps you — every screen has a button that carries on to deletion. The offers depend on the plan and are one per account, ever: a free account is offered 30 days of Pro free with no card — or 16 days if it has already had a Pro trial, so the free time adds up to 30 either way, once per person even across a deleted and re-created account — and can instead switch off every SwiftCard email and keep the card, link and contacts. A Pro subscriber is offered 50% off the next 3 months applied straight to the subscription, and can instead cancel Pro and keep the account with nothing deleted. Someone who subscribed in the app is told to turn off auto-renew in their Apple subscription settings — deleting here does not stop an Apple renewal. The \"what you lose\" screen counts their real contacts and card views and names the exact link that stops working; Pro accounts get a button to download their contacts first. Answers are saved even if the person stays. There is no \"Danger Zone\" and no section called \"Account\" — those names are gone. Deleting cancels any active subscription, and an office owner gets an extra warning because it ends the team's subscription for everyone — straight away: every team member is moved off Office and told so, and the admin console closes. Office accounts don't see the \"Refer a friend\" box (its free months are a Pro reward), so on Office that Settings section is called just \"Help\".",
    commerce: true,
    nativeAnswer:
      "Settings → Advanced account settings → \"Account ownership and deletion\" → \"Delete account\". It's a short numbered sequence: two questions about why you're leaving, an offer or two, a list of what you'd lose, then \"Type DELETE\" and your password. Nothing traps you — every screen has a button that carries on. For 30 days you can sign back in and press \"Reopen my account\" with everything intact; after that it is permanent and cannot be restored. If you subscribed in the app, deleting here does not stop the renewal — turn off auto-renew in your Apple subscription settings.",
  },
  {
    id: "referrals",
