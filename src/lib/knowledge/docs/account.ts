...
export const accountDocs = defineDocs([
  ...
  },
  {
    ...
    answer:
      "Settings → Notifications and preferences. The push switch at the top turns on instant alerts when someone shares their info — it's per device, so turn it on wherever you want alerts. Below it are the email switches — \"Marketing emails\" for everyone, and \"Payment receipts\" for anyone who is actually billed; press \"Save preferences\" to apply them.",
    detail:
