...
export const cardDocs = defineDocs([
  {
    ...
    detail:
      "Step by step, with the real headings: step 1 \"New card\" — name, title, phone numbers, email, website and address, ending in \"Next: Card design →\". Step 2 \"Card design\" — \"Add your logo and headshot, then pick a design.\" — logo, headshot, template and colours, ending in \"Next: Socials →\". Step 3 \"Socials\" — bio, social profiles and additional link buttons, ending in \"Next: Social design →\". Step 4 \"Social design\" — the look of your Swift Links page: pick a Look, choose the \"Page header\" style (full cover photo or a compact circle), and style your social icons and link buttons. A guest building their first card then picks a plan and creates an account; an existing user's card just goes live.",
  },
  {
    id: "edit-a-card",
    ...
    detail:
      "What lives on each tab, from their own hints: Card info — \"Name & contact details\" (plus your website, address, and the card's URL). Card design — \"Photos, template, colors & fonts\". Socials — \"Bio, socials & additional links\". Social design — \"Style your Swift Links page\". Social design also has a \"Show the 'View SwiftCard' button\" switch — on by default; turning it off removes the small link at the bottom of the Swift Links page that opens the card. The tab also offers a \"Page header\" choice — \"Cover photo\" (the classic full-width photo) or \"Compact circle\" (a small round photo that leaves more room for links; any plan) — and, with Pro, a \"Link buttons\" style: \"Tiles\" (rich preview cards, the default), \"Buttons\" (solid color rows) or \"Outline\" (bordered rows), plus a button color picker. Note the second tab is labelled \"Card design\", not \"Design\". On a team account the company-managed fields show a \"Managed by your organization\" tag and can't be changed from here.",
  },
  {
