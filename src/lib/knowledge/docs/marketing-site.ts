...
export const marketingDocs = defineDocs([
  {
    ...
    answer:
      "The homepage hero (desktop) rotates six example professionals — realtor, electrician, insurance agent, banker, lawyer, car salesperson — each shown three ways at once: their SwiftCard in a phone in the center, their Swift Links page on the left, and their Swift Signature on the right. Further down, the homepage's Swift Cards section shows the six templates and an AI Card Designer block (Create with AI, and Recreate any design from a screenshot of a card found online) that links to swiftcard.me/templates. The site covers: pricing at swiftcard.me/pricing, a live demo at swiftcard.me/preview, the card designs at swiftcard.me/templates (which also shows the AI Card Designer — \"Create with AI\" from your headshot, logo, colors and a style, and \"Recreate a design\" from a picture of a card you like; the designer itself is a Pro feature used from Edit card → Card design → Custom design), use cases at swiftcard.me/testimonials, and product pages under swiftcard.me/products/ (digital cards, SwiftLinks, Swift Signature, lead capture, analytics, teams, ways to share, Apple Watch, integrations), plus industry pages under swiftcard.me/for/ (real estate agents, contractors, insurance agents, loan officers, lawyers, photographers, barbers & stylists, car salespeople) \u2014 each opens with that profession's own example SwiftCard shown three ways: the card page in a phone, the Swift Links page, and the Swift Signature. The footer carries Product, Solutions and \"Who it's for\" link columns, Preview, Templates, Why SwiftCard, Contact Us, and swiftcard.me/company, swiftcard.me/privacy, swiftcard.me/terms and swiftcard.me/sms-terms.",
    detail:
