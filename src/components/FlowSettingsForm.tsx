  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[#F0EBE1] border border-[#E4DDD4] rounded-2xl px-4 py-3.5">
        ...
        <p className="text-slate-600 text-[0.8125rem] leading-relaxed">
      ...
      <div>
        <p className="text-xs font-bold text-slate-600 uppercase tracking-wider mb-3">Personal Note</p>
        ...
        />
        <p className="text-xs text-slate-600 mt-1 text-right">{(settings.customNote ?? "").length}/300</p>
      </div>
