...
export default function CreateOfficeForm() {
  ...
  return (
    <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 max-w-md mx-auto text-center">
      ...
      <h2 className="text-xl font-bold text-white mb-2">Set up your office</h2>
      ...
      <form onSubmit={handleSubmit} className="text-left space-y-4">
        <div>
          <label className="text-xs text-gray-500 block mb-1">Office / company name</label>
          <input
            type="text"
            value={name}
            ...
            required
            className="w-full bg-gray-800 border border-gray-700 text-white placeholder-gray-500 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-blue-500 transition-colors"
          />
        </div>
