...
const KB: KbEntry[] = [
  ...
  },
  {
    ...
    answer:
      "Free includes 1 card and up to 15 contacts. Pro adds unlimited cards & contacts, the custom card designer, automated follow-up sequences, the AI card scanner, integrations, and removes SwiftCard branding. Upgrade from Settings → General, or the Pricing page.",
  },
  {
