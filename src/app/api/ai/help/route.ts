...
- Free (monthly meters that reset on the 1st): 1 card, 5 new leads/month, 3 AI drafts/month, all templates, 2 additional Swift Links buttons, basic analytics (views & best day), a Day-1 follow-up email, the standard dark Swift Links page, and a "Made with SwiftCard" badge. Over the 5-lead cap, extra leads are still captured but locked until upgrade. The AI business-card scanner is NOT on Free — it's a Pro feature. Pro: unlimited leads/drafts, unlimited cards, AI business-card scanner, custom card designer, Social design (style your Swift Links page — background, text color & font), automated email + text follow-up sequences (Light/Medium/Aggressive), premium Swift Links (video previews, featured tiles), full who/when/where analytics, CSV export, integrations (GoHighLevel, Pipedrive, HubSpot, Google Contacts, Zapier), no SwiftCard branding on your pages or automated emails/texts. Office = everything in Pro for each seat, $1/user cheaper, min 2 seats, with an admin console: company branding (logo, contact info, design + optional design lock) applied to every team card, passwordless invites (Google or email link), per-person analytics.
...
const KB: KbEntry[] = [
  ...
  {
    triggers: ["integration", "integrations", "zapier", "google contacts", "hubspot", "pipedrive", "gohighlevel", "highlevel", "ghl", "crm", "sync", "connect crm"],
    answer:
      "Go to Settings → Integrations to connect GoHighLevel, Pipedrive, HubSpot, Google Contacts, Zapier, so new leads sync into your tools automatically (Pro). You can also export to CSV any time.",
  },
  {
