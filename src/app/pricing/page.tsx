...
const PRO_ANNUAL = 54;
const OFFICE_PER_USER = 3.99;
const OFFICE_PER_USER_YEAR = OFFICE_PER_USER * 12 * 0.9;
      ...
      <main className="overflow-clip">
        ...
        <section className="max-w-6xl mx-auto w-full px-5 sm:px-6 pb-24 grid grid-cols-1 md:grid-cols-3 gap-5 items-start">
          ...
          <div data-reveal className="rd-glass p-8 flex flex-col">
            ...
            <Link href="/login?mode=signup" className="rd-btn rd-btn-ghost-d w-full">Get started free →</Link>
          </div>
