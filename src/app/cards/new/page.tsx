...
export default function NewCardPage() {
  ...
  const [form, setForm] = useState({ username: "", name: "", title: "", company: "", phone: "", email: "", website: "" });
  ...
  const fields = [
    { key: "username", label: "Card URL username", placeholder: "e.g. john-business", hint: "Will be: /card/john-business" },
    { key: "name", label: "Full name", placeholder: "John Smith" },
    { key: "title", label: "Job title", placeholder: "Sales Director" },
  ...
  return (
    <main className="min-h-screen bg-gray-950 px-5 py-10">
      <div className="max-w-sm mx-auto">
        ...
        <p className="text-gray-400 text-sm mb-8">Create a second or third card — perfect for different roles or businesses.</p>
          ...
          {fields.map((f) => (
            <div key={f.key}>
              ...
              <input
                ...
                required={f.key === "username" || f.key === "name"}
